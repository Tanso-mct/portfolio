...
void balloon_shooter::TitleEntitiesFactory::Create
(
...
) const
{
    ...
    }
    {
        ...
        identity->SetName("TitleCamera");
    }

    balloon_shooter::TitleUIPrefab titleUIPrefab;
    std::unique_ptr<wb::IOptionalValue> titleUIEntityId = titleUIPrefab.Create(assetCont, entityCont, componentCont, entityIDView);
}