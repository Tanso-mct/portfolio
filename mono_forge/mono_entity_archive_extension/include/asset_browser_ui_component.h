...
class MONO_ENTITY_ARCHIVE_EXT_DLL AssetBrowserUIComponentHandle : public ecs::ComponentHandle<AssetBrowserUIComponentHandle> {};

// The component class
class MONO_ENTITY_ARCHIVE_EXT_DLL AssetBrowserUIComponent : //REFLECTABLE_COMMENT_BEGIN//
    public ecs::Component
{
public:
    AssetBrowserUIComponent();
    virtual ~AssetBrowserUIComponent() override;
