...
class MONO_GRAPHICS_EXT_DLL WindowRenderBindComponentHandle : public ecs::ComponentHandle<WindowRenderBindComponentHandle> {};

// The component class
class MONO_GRAPHICS_EXT_DLL WindowRenderBindComponent :
    public ecs::Component
{
public:
    WindowRenderBindComponent(std::unique_ptr<mono_service::ServiceProxy> graphics_service_proxy);
    virtual ~WindowRenderBindComponent() override;
    ...
    public:
        SetupParam() :
            imgui_create_func(nullptr),
            imgui_destroy_func(nullptr)
        {
        }
        ...
        render_graph::ImguiContext::ContextCreateFunc imgui_create_func;

        // The Imgui context destruction function
        render_graph::ImguiContext::ContextDestroyFunc imgui_destroy_func;
