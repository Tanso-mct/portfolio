...
public:
    ...
    // Get the material type handle ID for a material handle
    render_graph::MaterialTypeHandleID GetMaterialType(const render_graph::MaterialHandle* material_handle) const;
};
