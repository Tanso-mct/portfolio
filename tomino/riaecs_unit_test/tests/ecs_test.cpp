...
namespace
{
    ...
    public:
        ...
        ) override
        {
            ...
            for (const riaecs::Entity &entity : ecsWorld.View(TestAComponentID())())
            {
                TestAComponent* test = riaecs::GetComponent<TestAComponent>(ecsWorld, entity, TestAComponentID());
...
TEST(ECS, World)
{
    ...
    // Get component
    {
        TestAComponent* test = riaecs::GetComponent<TestAComponent>(*ecsWorld, entity1, TestAComponentID());
        ...
        for (const riaecs::Entity &entity : ecsWorld->View(TestAComponentID())())
        {
            TestAComponent* testFromView = riaecs::GetComponent<TestAComponent>(*ecsWorld, entity, TestAComponentID());
    ...
    // Get component
    {
        TestBComponent* test = riaecs::GetComponent<TestBComponent>(*ecsWorld, entity2, TestBComponentID());
        ...
        for (const riaecs::Entity &entity : ecsWorld->View(TestBComponentID())())
        {
            TestBComponent* testFromView = riaecs::GetComponent<TestBComponent>(*ecsWorld, entity, TestBComponentID());
